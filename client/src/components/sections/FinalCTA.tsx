    ...
    <section className="py-24 bg-secondary/10 relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 text-center space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="flex flex-col items-center space-y-2 p-6 rounded-xl bg-white/50 backdrop-blur-sm hover:bg-white transition-colors duration-300">
          ...
          <div className="flex flex-col items-center space-y-2 p-6 rounded-xl bg-white/50 backdrop-blur-sm hover:bg-white transition-colors duration-300">
            ...
            <Button size="lg" variant="ghost" className="w-full text-primary hover:bg-secondary/20 underline decoration-1 underline-offset-4">
              Pelas Obras
            </Button>
          </div>
        </div>
